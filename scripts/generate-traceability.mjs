...
const evidence = {
  CORE: "Inbound API, integration run/error, Resource360FreshnessService fail-closed decision gates, role scope/sharing, outbox and workspace source/freshness contracts",
  ...
  SFCOE: "Effective-dated Resource360RoleCatalog metadata, capability/credential/evidence model, normalized explainable fit policy v2 and 103 governed screen contracts",
  TS: "Resource360TimeService, work-calendar/time-zone deadlines, immutable actuals, correction lineage, configurable dual-control decisions, escalation/auto-approval scheduler and actuals report type",
