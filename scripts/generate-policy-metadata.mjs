...
const policies=[
  ...
  ["Allocation_Line_Max_Hours","Allocation Line Maximum Hours","number",8,"Maximum daily hours permitted on one project-allocation line."],
  ["Allocation_Overage_Ceiling_Hours","Over-allocation Ceiling Hours","number",12,"Absolute aggregate daily planning ceiling; hours above standard capacity require independent approval."],
  ["Allocation_Overage_Ceiling_Percent","Over-allocation Ceiling Percent","number",150,"Absolute aggregate daily planning ceiling expressed as a percentage of the eight-hour standard."],
  ["Allocation_Overage_Review_Days","Allocation Over-allocation Review Days","number",30,"Maximum number of calendar days before an approved over-allocation requires another review."],
  ...
  ["Time_Max_Daily_Hours","Time Maximum Daily Hours","number",8,"Maximum actual time-entry hours per employee per work date unless a future approved overtime policy changes it."],
  ...
  ["KPI_Full_Allocation_Coverage_Target","KPI Full Allocation Coverage Target","number",100,"Target share of active resources with at least eight aggregate daily allocation hours in the demo population."],
  ["KPI_Overallocated_Max_Percent","KPI Overallocated Maximum Percent","number",20,"Maximum share of active resources in approved controlled over-allocation."],
  ["KPI_Pending_Overallocation_Max","KPI Pending Overallocation Maximum","number",0,"Target maximum number of unpublished over-allocation plans awaiting decision."],
