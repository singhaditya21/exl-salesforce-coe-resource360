...
| Recorded evidence | `pnpm test:videos` | Any of seventeen MP4s, posters or captions is missing, malformed, truncated or differs from its integrity manifest; any v3 master lacks stream, contact-sheet, stage-count or visual-state evidence |
