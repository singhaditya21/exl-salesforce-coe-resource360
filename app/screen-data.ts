...
export const screens: ScreenSpec[] = [
  ...
  s("STFUI-01", "Add-resource launcher", "staffing", "form", "Start a governed resource request from an approved engagement and budget.", "Continue", "R1", "New staffing request"),
  ...
  s("STFUI-18", "Allocation action menu", "staffing", "detail", "Permission-aware details, schedule, modify, split and deallocation actions.", "View details", "R1", "Allocation actions"),
  ...
  s("STFUI-21", "Staffing queue", "staffing", "list", "Prioritized pending requests with age, fit, conflict, budget and ownership context.", "Review next", "R1", "Staffer workbench"),
  ...
  s("SKLUI-14", "Pending reviews", "skills", "list", "Prioritized capability claims with evidence, age and decision entry points.", "Review next", "R1", "Manager workspace"),
  ...
  s("BUDUI-09", "Approval queue", "budget", "list", "Prioritize budgets by active approval level, margin, change and age.", "Review next", "R1", "Approvals"),
  ...
  s("TIMEUI-04", "Manager team view", "timesheet", "list", "Track employee-week state, totals, exceptions and approval entry points.", "Review next", "R1", "Team time"),
