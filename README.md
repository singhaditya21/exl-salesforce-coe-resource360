...
- A seven-work-package dynamic Project Manager Gantt with dependency cascade, critical path, accepted allocation coverage, progress/acceptance evidence, contract-line traceability, risks and fail-closed completion gates. See the [golden-path contract](docs/PROJECT_DELIVERY_GOLDEN_PATH.md).
